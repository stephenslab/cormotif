...
Changing the threshold for lfsr, we plot the ROC curve for $K=1,2,4,10$. Notice that when $K=1$, it is equvalent to apply ash to each study separately, and $K = 4$ is the true model.
